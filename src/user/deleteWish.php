...
if($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['id_wish'])){
    try {
        ...
        //DELETE WISH
        $stmt = $conn->prepare("DELETE FROM wishes WHERE id_wish = :id_wish AND id_household = :householdID");
        $stmt->bindParam(":id_wish", $_POST['id_wish']);
